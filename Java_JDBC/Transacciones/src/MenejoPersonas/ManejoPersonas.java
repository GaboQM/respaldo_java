...
public class ManejoPersonas {
    public static void main(String[] args) {
        ...
        try {
            ...
            personas.update(3, "Josué", "García");

             //testeando sin error
             //personas.insert("Ofelia","Olivares");
             
            //Provocamos un error superando los 45 caracteres
            //del campo de apellido
           // personas.insert("Miguel2","Ayala12341234123412341234123412341234123412341234123412341234123412341234123412341234");
                    //"Ayala2");
