...
public class TestPersonaServiceRS {
    ...
    private static final String URL_BASE = "http://localhost:45152/SgaJeeWeb/webservice";
    ...
    public static void main(String[] args) {
       ...
       // persona = webTarget.path("/12").request(MediaType.APPLICATION_XML).get(Persona.class);        
...
*/
    ...
    /*    //Agregar una persona (metodo post)       
        ...
        nuevaPersona.setTelefono("044556454");
        ...
        Persona personaModificar = webTarget.path("/13").request(MediaType.APPLICATION_XML).get(Persona.class);  
...
*/
        ...
        // persona recuperada anteriormente        
        Persona personaEliminar = webTarget.path("/13").request(MediaType.APPLICATION_XML).get(Persona.class);  
