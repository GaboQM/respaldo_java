 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://servicio.sga.gm.com.mx/", wsdlLocation = "http://localhost:45152/PersonaServiceImplService/PersonaServiceImpl?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:45152/PersonaServiceImplService/PersonaServiceImpl?WSDL");
