...
//	Hashtable s una estructura de datos que utiliza una función hash para identificar datos mediante una llave o clave
...
//				for (int m=0;m<disDisparo;m+=5){// cada cinco puntos
			...
			if (mEliminarMarciano){
				...
				if (tam>10){
					...
					//dividimos el marciano en dos nuevos a la miatad de su tamaño
					tam=tam/2;
